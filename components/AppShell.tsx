...
const LINKS: NavLink[] = [
  { href: '/', key: 'nav_check', min: 'worker', feature: 'check' },
  { href: '/products', key: 'nav_catalog', min: 'worker', feature: 'catalog' },
  { href: '/warehouses', key: 'nav_stock', min: 'worker', feature: 'stock' },
  { href: '/price-tags', key: 'nav_pricetags', min: 'worker', feature: 'pricetags' },
  { href: '/wms', key: 'nav_wms', min: 'worker', feature: 'wms' },
  { href: '/movements', key: 'nav_movements', min: 'manager', feature: 'movements' },
  { href: '/orders', key: 'nav_orders', min: 'manager', feature: 'orders' },
  { href: '/history', key: 'nav_history', min: 'manager', feature: 'history' },
  { href: '/logistics', key: 'nav_logistics', min: 'manager', feature: 'logistics' },
  { href: '/cash', key: 'nav_cash', min: 'manager', feature: 'cash' },
